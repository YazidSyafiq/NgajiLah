...
//
//     final jadwalSholatResponse = jadwalSholatResponseFromJson(jsonString);

import 'dart:convert';

JadwalSholatResponse jadwalSholatResponseFromJson(String str) =>
    JadwalSholatResponse.fromJson(json.decode(str));

String jadwalSholatResponseToJson(JadwalSholatResponse data) =>
    json.encode(data.toJson());

class JadwalSholatResponse {
  int? code;
  String? status;
  Data? data;
  ...
  factory JadwalSholatResponse.fromJson(Map<String, dynamic> json) =>
      JadwalSholatResponse(
        code: json["code"],
        status: json["status"],
